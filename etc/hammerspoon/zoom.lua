...
local printDebugState = function()
  hs.printf("app: %s, meeting: %s, audio: %s, video: %s, share: %s", state.app, state.meeting, state.audio, state.video, state.share)
end
...
local init = function()
  local aw = hs.application.watcher.new(function (appName, eventType, app)
